    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, user_service_1.default.create(name, email, password)];
                case 2:
                    _b.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    user = _b.sent();
                    return [2 /*return*/, res.status(http_status_1.default.OK).send(user)];
                case 3:
                    error_2 = _b.sent();
                    next(error_2);
                    return [3 /*break*/, 4];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, user_service_1.default.getUserById(id)];
                case 2:
                    user = _a.sent();
                    return [2 /*return*/, res.status(http_status_1.default.OK).send(user)];
                case 3:
